...
In order to show a selection of the factor used for the simulations we create a fuction in which the levels of each of the factors is selected ramdonmly 
