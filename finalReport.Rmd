...
In order to show a selection of the levels within each of the factors used for the simulations we created a fuction **Multi Scenario Funtion** in which the levels of each of the factors is selected ramdonmly. For example Table 2 and 3 shows the randomly selected factor for soybean and corn, respectively. 
...
To generate the scenarios we used as an input of the function the **soybeanKey** and the **cornKey** created usign the following script : 
...
We will now explore the data by generating a selection of graphs to visualize and answar some interesting questions about corn and soybean grwoing under different scenarios. 
